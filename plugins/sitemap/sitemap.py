...
class SitemapGenerator(object):
    ...
    def __init__(self, context, settings, path, theme, output_path, *null):
        ...
        if not isinstance(config, dict):
            ...
            valid_keys = ('articles', 'indexes', 'pages', 'authors', 'home')
    ...
    def write_url(self, page, fd):
        ...
        elif isinstance(page, contents.Author):
            pri = self.priorities['authors']
            chfreq = self.changefreqs['authors']
        elif isinstance(page, contents.Author):
            pri = self.priorities['authors']
            chfreq = self.changefreqs['authors']
        elif page.url == "index.html":
            pri = self.priorities['home']
            chfreq = self.changefreqs['home']
        else:
